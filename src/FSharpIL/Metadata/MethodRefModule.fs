...
let inline addRowDefault (builder: CliMetadataBuilder) (method: inref<MethodRefDefault>) =
    builder.MemberRef.Add &method

/// <summary>Adds a reference to a method with the <c>GENERIC</c> calling convention.</summary>
let inline addRowGeneric (builder: CliMetadataBuilder) (method: inref<MethodRefGeneric>): struct(RawIndex<MethodRefGeneric> * _) =
    builder.MemberRef.Add &method

/// <summary>Adds a reference to a method with the <c>VARARG</c> calling convention.</summary>
let inline addRowVarArg (builder: CliMetadataBuilder) (method: inref<MethodRefVarArg>): struct(RawIndex<MethodRefVarArg> * _) =
    builder.MemberRef.Add &method
